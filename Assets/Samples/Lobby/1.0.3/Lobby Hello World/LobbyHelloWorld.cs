...
public class LobbyHelloWorld : MonoBehaviour
{
    ...
    public void LogLobbyData(){
        ...
        Debug.Log($"Current lobby {currentLobby.Name} ({currentLobby.Id})");  
    ...
    async Task ExecuteLobbyDemoAsync()
    {
        ...
        // Allow clones to appear as a different machine
        #if UNITY_EDITOR
        ...
        // Temporary to allow multiple accounts on one machine
    ...
    public async void SetLobbyData(){
        Player loggedInPlayer = await GetPlayerFromAnonymousLoginAsync();
    ...
    public async void JoinQuickLobby(){
